...
/* harmony export */   "default": () => (/* binding */ APIProcessor)
/* harmony export */ });
class APIProcessor {
  async processWeatherForecast(promise) {
    try {
      ...
      alert("Error processing weather forecast. Please reload the page and try again.");
    }
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ APIRequester)
/* harmony export */ });
class APIRequester {
...
class UIDisplay {
  display(dataObject) {
    ...
    const dateObject1 = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.parse)(dateData1, "yyyy-MM-dd", new Date());
    const formattedDate1 = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(dateObject1, "EEEE, MMMM d, yyyy");
    ...
    const dateObject2 = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.parse)(dateData2, "yyyy-MM-dd", new Date());
    const formattedDate2 = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(dateObject2, "EEEE, MMMM d, yyyy");
    ...
    const dateObject3 = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.parse)(dateData3, "yyyy-MM-dd", new Date());
    const formattedDate3 = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(dateObject3, "EEEE, MMMM d, yyyy");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UIForm)
/* harmony export */ });
/* harmony import */ var _api_requester__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api_requester */ "./src/api_requester.js");
/* harmony import */ var _api_processor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api_processor */ "./src/api_processor.js");
/* harmony import */ var _ui_displayer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ui_displayer */ "./src/ui_displayer.js");



let apirequester = new _api_requester__WEBPACK_IMPORTED_MODULE_0__["default"]();
let apiprocessor = new _api_processor__WEBPACK_IMPORTED_MODULE_1__["default"]();
let uidisplay = new _ui_displayer__WEBPACK_IMPORTED_MODULE_2__["default"]();
class UIForm {
  async CitySearch() {
    ...
    submit.addEventListener("click", async event => {
      ...
      if (!regex.test(form.value)) {
        ...
        const fetch = await apirequester.requestWeatherForecast(city).catch("ERROR FETCHING DATA. PLEASE TRY AGAIN.");
        const data = await apiprocessor.processWeatherForecast(fetch).catch("ERROR PROCESSING DATA. PLEASE TRY AGAIN.");
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./TiltNeon-Regular-VariableFont_XROT,YROT.ttf */ "./src/TiltNeon-Regular-VariableFont_XROT,YROT.ttf"), __webpack_require__.b);
...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;EACE,iBAAiB;EACjB,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,wBAAwB;EACxB,+DAA4E;EAC5E,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;;EAEE,UAAU;EACV,SAAS;EACT,YAAY;EACZ,wBAAwB;AAC1B;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,aAAa;EACb;;;cAGY;EACZ,kCAAkC;AACpC;;AAEA;EACE,cAAc;EACd,gBAAgB;EAChB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,uBAAuB;EACvB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,eAAe;EACf,gBAAgB;EAChB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,uBAAuB;EACvB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,uBAAuB;EACvB,kBAAkB;EAClB,YAAY;EACZ,aAAa;EACb,aAAa;EACb,sBAAsB;EACtB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,UAAU;EACV,6BAA6B;EAC7B,iBAAiB;EACjB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,cAAc;EACd,SAAS;EACT,UAAU;AACZ;;AAEA;EACE;IACE,aAAa;IACb;;;;;UAKM;IACN,0BAA0B;EAC5B;AACF","sourcesContent":[":root {\n  --color1: #444444;\n  --color2: #999999;\n  --color3: #cccccc;\n}\n\n@font-face {\n  font-family: \"Tilt Neon\";\n  src: url(\"./TiltNeon-Regular-VariableFont_XROT,YROT.ttf\") format(\"truetype\");\n  font-weight: 400;\n  font-style: normal;\n}\n\nhtml,\nbody {\n  padding: 0;\n  margin: 0;\n  height: 100%;\n  font-family: \"Tilt Neon\";\n}\n\ninput {\n  font-family: \"Tilt Neon\";\n}\n\n.container {\n  display: grid;\n  grid-template-areas:\n    \"bar bar bar\"\n    \"bar2 bar2 bar2\"\n    \"s1 s2 s3\";\n  grid-template-columns: 1fr 1fr 1fr;\n}\n\n.upper_bar {\n  grid-area: bar;\n  min-height: 80px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 2px solid black;\n  border-radius: 5px;\n  margin: 10px;\n}\n\n.bar2 {\n  grid-area: bar2;\n  min-height: 40px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 2px solid black;\n  border-radius: 5px;\n  margin: 10px;\n}\n\n#slot1 {\n  grid-area: s1;\n}\n\n#slot2 {\n  grid-area: s2;\n}\n\n#slot3 {\n  grid-area: s3;\n}\n\n.slot {\n  border: 2px solid black;\n  border-radius: 5px;\n  margin: 10px;\n  padding: 10px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\n.slot img {\n  height: 100px;\n  width: 100px;\n  margin-top: 10px;\n}\n\n.temp {\n  font-size: 200%;\n  margin-top: -10px;\n  margin-bottom: 10px;\n}\n\n.extra_bar {\n  background-color: grey;\n  border-radius: 5px;\n  display: flex;\n  flex-direction: row;\n  width: 80%;\n  justify-content: space-around;\n  margin-left: 30px;\n  margin-right: 30px;\n  height: 50px;\n}\n\n.extra_bar div {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  padding: 5px;\n}\n\n.extra_sub {\n  font-size: 120%;\n}\n\n.extra_sub p {\n  font-size: 60%;\n  margin: 0;\n  padding: 0;\n}\n\n@media screen and (max-width: 670px) {\n  .container {\n    display: grid;\n    grid-template-areas:\n      \"bar\"\n      \"bar2\"\n      \"s1\"\n      \"s2\"\n      \"s3\";\n    grid-template-columns: 1fr;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/TiltNeon-Regular-VariableFont_XROT,YROT.ttf":
/*!*********************************************************!*\
  !*** ./src/TiltNeon-Regular-VariableFont_XROT,YROT.ttf ***!
  \*********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/* harmony import */ var _ui_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui_form */ "./src/ui_form.js");


let uiform = new _ui_form__WEBPACK_IMPORTED_MODULE_1__["default"]();
uiform.CitySearch();
